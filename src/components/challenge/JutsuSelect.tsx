...
export const JutsuSelect: React.FC<JutsuSelectProps> = ({ onSelect }) => {
    ...
    return (
        <div className="flex flex-col gap-4 w-full max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl text-konoha-orange font-ninja text-center drop-shadow-chakra-sm">
                {t('jutsu.title')}
            </h2>
                ...
                {SUPPORTED_JUTSUS.map((jutsu) => {
                    ...
                    return (
                        <button
                            ...
                            className="group relative bg-black/60 border border-white/10 rounded-lg p-4 text-left
                       hover:border-konoha-orange/60 hover:bg-black/75 hover:shadow-chakra-sm
